...
<%
String fname=null,add=null,pin=null,email=null,state=null,ph=null;
try
{
Statement st=null;
...
<h6 align="center">
<b><font size="7">
 <font face="Arial, Helvetica, sans-serif">Billing Details</font>
</font></b></h6>
...
<input type="text" name="caddress" size="30" maxlength="30" value=<%=add %>>
...
<td width="41%">
 ...
 <input type="text" name="clandmark" size="30" maxlength="30" value=<%=pin %>>
