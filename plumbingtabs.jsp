...
ResultSet rs=st.executeQuery("select * from addservice where category='Plumbing Services'");
while(rs.next())
{
	%>
	...
	<div class="image">
            ...
            <a class="add-cart cart1" href="add2cart2.jsp?id1=<%=rs.getInt(1)%>">Add to List</a>
        </div>
