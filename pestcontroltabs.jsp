...
ResultSet rs=st.executeQuery("select * from addservice where category='Pest Controlling'");
while(rs.next())
{
	%>
	...
	<div class="image">
            ...
            <a class="add-cart cart1" href="add4cart4.jsp?id1=<%=rs.getInt(1)%>">Add to List</a>
        </div>
