<html>
<head>
    <title>Sign up form design</title></head>
    ...
    <body class="bg-image">
        ...
        <div id="login-box">
            <div class="left-box">
                <form action="savesignup.jsp" name="form1" id="signup" class="input-group" method="post">
                    <h1>Sign Up</h1>
            ...
            <input type="submit" name="signup-button" value="SignUp"/>
                ...
                <form action="savesignup.jsp" id="login" class="input-group">
                      <h1>Login</h1>
            ...
            <div class="right-box">
               ...
               <a href="http://www.twitter.com"> <button class="social twitter">Log In With Twitter</button>
               <a href="#"> <button class="social Google">Log In With Google+</button>
                <div class="form-box">
