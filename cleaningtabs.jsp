...
ResultSet rs=st.executeQuery("select * from addservice where category='Cleaning Services'");
while(rs.next())
{
	%>
	...
	<div class="image">
            ...
            <a class="add-cart cart1" href="add3cart3.jsp?id1=<%=rs.getInt(1)%>">Add to List</a>
        </div>
