...
try
{
	...
	int j=st.executeUpdate("insert into profession(fname, lname, email, phoneno, address, gender, 10th, 12th, graduation, specialization) values('"+fnm+"','"+lnm+"','"+mail+"','"+phno+"','"+addr+"','"+gend+"','"+q1+"','"+q2+"','"+q3+"','"+sp+"')");
	if(j>0)
		%>
